"""Reference implementation for Energy Minimization.

Delegates to computronium.ontology.dynamics.EnergyMinimizationDynamics (the source of truth).
...
def _case_to_composite_state(case: Any) -> CompositeState:
    """Convert a test case to a CompositeState for EnergyMinimizationDynamics."""
    # EnergyMinimizationDynamics expects a CompositeState with x (input) and layer activations
