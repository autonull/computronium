"""Reference implementation for Predictive Settling.

Delegates to computronium.ontology.dynamics.PredictiveSettlingDynamics (the source of truth).
...
def _case_to_composite_state(case: Any) -> CompositeState:
    """Convert a test case to a CompositeState for PredictiveSettlingDynamics."""
