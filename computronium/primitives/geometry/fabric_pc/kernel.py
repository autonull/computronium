"""Accelerated kernel for Fabric PC Geometry.

Delegates to computronium.ontology.geometry.GraphGeometry (adapted from FabricPC
graph API) with triton acceleration. Provides uniform `forward(case)` interface.
"""
