"""Reference implementation for Spatial Lattice 3D Geometry.

Delegates to computronium.ontology.geometry.SpatialLattice3DGeometry (the source of truth).
This wrapper provides the uniform `forward(case)` interface for parity/microbench.
"""
