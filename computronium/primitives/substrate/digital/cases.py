"""Deterministic test cases for Digital Substrate.
...
def make_case(
    *,
    ...
    """Create a deterministic test case for digital substrate."""
...
def make_case_noisy(
    *,
    ...
    """Create a deterministic test case for noisy digital substrate."""
    spec = SubstrateSpec(
        execution_model=ExecutionModel.NATIVE,
        device_model=DeviceModel.DIGITAL,
        numeric_representation=NumericRepresentation.REAL,
...
def make_case_sparse(
    *,
    ...
    """Create a deterministic test case for sparse digital substrate."""
    spec = SubstrateSpec(
        execution_model=ExecutionModel.NATIVE,
        device_model=DeviceModel.DIGITAL,
        numeric_representation=NumericRepresentation.REAL,
