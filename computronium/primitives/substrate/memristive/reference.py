"""Reference implementation for Memristive Substrate.
...
def make_substrate(spec: SubstrateSpec):
    """Create a memristive substrate instance from a SubstrateSpec.

    This is a thin wrapper around the ontology's make_substrate that
    ensures the substrate type is memristive.
    """
    from computronium.ontology.substrate.spec import DeviceModel

    if spec.device_model.value != "memristive":
        spec = spec.__class__(
