"""Deterministic test cases for Memristive Substrate.
...
def make_case(
    *,
    ...
    """Create a deterministic test case for memristive substrate."""

    spec = SubstrateSpec(
        execution_model=ExecutionModel.NATIVE,
        device_model=DeviceModel.MEMRISTIVE,
        ...
        cost_model=CostConfig(joules_per_mac=1e-12, fab_cost_ratio=1.5),
        substrate_type=None,
    )
...
def make_case_noisy(
    *,
    ...
    """Create a deterministic test case for noisy memristive substrate."""
    spec = SubstrateSpec(
        execution_model=ExecutionModel.NATIVE,
        device_model=DeviceModel.MEMRISTIVE,
        numeric_representation=NumericRepresentation.REAL,
