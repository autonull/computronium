"""Deterministic test cases for Noisy Substrate.
...
def make_case(
    *,
    ...
    """Create a deterministic test case for noisy substrate."""
    ...
    spec = SubstrateSpec(
        ...
        noise_model=NoiseConfig(kind="additive_gaussian", level=0.1),
...
def make_case_high_noise(
    *,
    ...
    """Create a deterministic test case for high-noise substrate."""
    spec = SubstrateSpec(
        execution_model=ExecutionModel.NATIVE,
        device_model=DeviceModel.DIGITAL,
        numeric_representation=NumericRepresentation.REAL,
