"""Reference implementation for Quantum Substrate.
...
def make_substrate(spec: SubstrateSpec):
    """Create a quantum substrate instance from a SubstrateSpec.

    This is a thin wrapper around the ontology's make_substrate that
    ensures the substrate type is quantum.
    """
    # Ensure quantum device model
    if spec.device_model.value != "quantum":
