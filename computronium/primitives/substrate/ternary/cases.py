"""Deterministic test cases for Ternary Substrate.
...
def make_case(
    *,
    ...
    """Create a deterministic test case for ternary substrate."""

    spec = SubstrateSpec(
        execution_model=ExecutionModel.NATIVE,
        device_model=DeviceModel.DIGITAL,
        numeric_representation=NumericRepresentation.TERNARY,
