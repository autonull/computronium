...
"""Ternary Substrate primitive.

This primitive implements the digital substrate with ternary weight quantization

Reference implementation:
    computronium.primitives.substrate.ternary.reference

Accelerated kernel:
    computronium.primitives.substrate.ternary.kernel
"""
