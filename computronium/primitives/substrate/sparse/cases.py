"""Deterministic test cases for Sparse Substrate.
...
def make_case(
    *,
    ...
    """Create a deterministic test case for sparse substrate."""
    ...
    spec = SubstrateSpec(
        ...
        structural_constraints=ConstraintConfig(weight_bounds=None, sparsity=0.5),
...
def make_case_high_sparsity(
    *,
    ...
    """Create a deterministic test case for high-sparsity substrate."""
    spec = SubstrateSpec(
        execution_model=ExecutionModel.NATIVE,
        device_model=DeviceModel.DIGITAL,
        numeric_representation=NumericRepresentation.REAL,
        noise_model=NoiseConfig(kind="none", level=0.0),
        structural_constraints=ConstraintConfig(weight_bounds=None, sparsity=sparsity),
        cost_model=CostConfig(joules_per_mac=0.0, fab_cost_ratio=1.0),
        substrate_type=None,
    )
