"""Deterministic test cases for Neuromorphic Substrate.
...
def make_case(
    *,
    ...
    """Create a deterministic test case for neuromorphic substrate."""

    spec = SubstrateSpec(
        execution_model=ExecutionModel.SIMULATED,
        device_model=DeviceModel.NEUROMORPHIC,
        ...
        structural_constraints=ConstraintConfig(
            weight_bounds=(-1.0, 1.0), sparsity=0.0
        ),
        cost_model=CostConfig(joules_per_mac=1e-15, fab_cost_ratio=2.0),
        substrate_type=None,
    )
...
def make_case_noisy(
    *,
    ...
    """Create a deterministic test case for noisy neuromorphic substrate."""
    spec = SubstrateSpec(
        execution_model=ExecutionModel.SIMULATED,
        device_model=DeviceModel.NEUROMORPHIC,
        numeric_representation=NumericRepresentation.REAL,
