"""Deterministic test cases for Photonic Substrate.
...
def make_case(
    *,
    ...
    """Create a deterministic test case for photonic substrate."""
...
def make_case_noisy(
    *,
    ...
    """Create a deterministic test case for noisy photonic substrate."""
    spec = SubstrateSpec(
        execution_model=ExecutionModel.NATIVE,
        device_model=DeviceModel.PHOTONIC,
        numeric_representation=NumericRepresentation.COMPLEX,
