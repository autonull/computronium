...
This primitive implements the optical/photonic substrate with phase/amplitude encoding

Reference implementation:
    computronium.primitives.substrate.photonic.reference

Accelerated kernel:
    computronium.primitives.substrate.photonic.kernel
"""
