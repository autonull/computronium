...
def _build_parser() -> argparse.ArgumentParser:
    ...
    # list
    list_parser = subparsers.add_parser("list", help="List available benchmark suites")  # noqa: F841
...
def _run_benchmark(args) -> int:
    ...
    result = subprocess.run(cmd, capture_output=False, text=True)  # noqa: PLW1510, S603
