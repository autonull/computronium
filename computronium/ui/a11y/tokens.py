...
def a11y_css() -> str:
    ...
    return "\n".join([
        ...
        FOCUS_VISIBLE_CSS,
        "",
        "/* AA on white: Quasar .text-grey (#9e9e9e) is only 2.67:1.\n",
        "   html body beats Quasar's later-loaded !important via specificity. */",
        "html body .text-grey { color: #616161 !important; }",
        "/* Also catch .text-grey-* if any */",
        "html body .text-grey-5, html body .text-grey-6 { color: #616161 !important; }",
        "/* Header selects render near-black .ellipsis on bg-primary */",
        ".q-header .ellipsis, .bg-primary .ellipsis { color: #ffffff !important; }",
        "",
        "/* Reduced motion */",
