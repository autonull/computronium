"""Public factory for MomentumEqprop systems.

Wraps computronium.core.presets.create_momentum_eqprop_mlp, adding backend selection.
"""
...
from computronium.core.presets import (
    create_momentum_eqprop_mlp as _create_momentum_eqprop_mlp,
)
...
def create_momentum_eqprop_mlp(
    ...
    *,
    ...
    """
    Create a MomentumEqprop system.
    ...
    """
    spec = get("algorithm.momentum_eqprop")
    backend = select_backend(spec, backend)

    return _create_momentum_eqprop_mlp(
        input_dim=input_dim,
