"""Reference implementation for MomentumEqprop algorithm.

Composes Momentum Eqprop training step using primitives.
"""
...
def _make_momentum_eqprop_system(config: _SystemConfig) -> Any:
    """Create a MomentumEqprop system for testing."""
...
def step(case: Any) -> Any:
    ...
    try:
        ...
        system = _make_momentum_eqprop_system(system_config)
