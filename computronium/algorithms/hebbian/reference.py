"""Reference implementation for Hebbian algorithm.

Composes Hebbian training step with local correlation updates.
"""
...
def _make_hebbian_system(config: _SystemConfig) -> Any:
    """Create a Hebbian system for testing."""
...
def step(case: Any) -> Any:
    ...
    try:
        ...
        system = _make_hebbian_system(system_config)
