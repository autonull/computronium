"""Reference implementation for Backprop algorithm.

Composes standard backprop training step using PyTorch autograd.
"""
...
def _make_backprop_system(config: _SystemConfig) -> Any:
    """Create a Backprop system for testing."""
...
def step(case: Any) -> Any:
    ...
    try:
        ...
        system = _make_backprop_system(system_config)
