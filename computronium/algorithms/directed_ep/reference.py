"""Reference implementation for DirectedEp algorithm.

Composes Directed Ep training step using primitives.
"""
...
def _make_directed_ep_system(config: _SystemConfig) -> Any:
    """Create a DirectedEp system for testing."""
...
def step(case: Any) -> Any:
    ...
    try:
        ...
        system = _make_directed_ep_system(system_config)
