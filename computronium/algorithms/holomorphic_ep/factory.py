"""Public factory for HolomorphicEp systems.

Wraps computronium.core.presets.create_holomorphic_ep_mlp, adding backend selection.
"""
...
from computronium.core.presets import (
    create_holomorphic_ep_mlp as _create_holomorphic_ep_mlp,
)
...
def create_holomorphic_ep_mlp(
    ...
    *,
    ...
    """
    spec = get("algorithm.holomorphic_ep")
    backend = select_backend(spec, backend)

    return _create_holomorphic_ep_mlp(
        input_dim=input_dim,
