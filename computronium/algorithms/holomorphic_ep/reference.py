"""Reference implementation for HolomorphicEp algorithm.

Composes Holomorphic Ep training step using primitives.
"""
...
def _make_holomorphic_ep_system(config: _SystemConfig) -> Any:
    """Create a HolomorphicEp system for testing."""
...
def step(case: Any) -> Any:
    ...
    try:
        ...
        system = _make_holomorphic_ep_system(system_config)
