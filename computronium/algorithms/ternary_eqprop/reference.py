"""Reference implementation for TernaryEqprop algorithm.

Composes Ternary Eqprop training step using primitives.
"""
...
def _make_ternary_eqprop_system(config: _SystemConfig) -> Any:
    """Create a TernaryEqprop system for testing."""
...
def step(case: Any) -> Any:
    ...
    try:
        ...
        system = _make_ternary_eqprop_system(system_config)
