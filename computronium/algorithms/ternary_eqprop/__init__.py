...
"""TernaryEqprop algorithm.

Ternary-Weight Equilibrium Propagation with STE quantization

Reference implementation:
    computronium.algorithms.ternary_eqprop.reference

Accelerated kernel:
    computronium.algorithms.ternary_eqprop.kernel
"""
...
from .factory import create_ternary_eqprop_mlp
