"""Reference implementation for Direct Feedback Alignment algorithm.

Composes DFA training step using direct fixed random feedback from output to all layers.
"""
...
def _make_dfa_system(config: _SystemConfig) -> Any:
    """Create a DFA system for testing."""
