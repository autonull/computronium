"""Reference implementation for DiffusionEqprop algorithm.

Composes Diffusion Eqprop training step using primitives.
"""
...
def _make_diffusion_eqprop_system(config: _SystemConfig) -> Any:
    """Create a DiffusionEqprop system for testing."""
...
def step(case: Any) -> Any:
    ...
    try:
        ...
        system = _make_diffusion_eqprop_system(system_config)
