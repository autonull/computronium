...
"""DiffusionEqprop algorithm.

Diffusion Equilibrium Propagation with continuous-time dynamics

Reference implementation:
    computronium.algorithms.diffusion_eqprop.reference

Accelerated kernel:
    computronium.algorithms.diffusion_eqprop.kernel
"""
...
from .factory import create_diffusion_eqprop_mlp
