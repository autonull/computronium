"""Public factory for Equilibrium Propagation systems.

Wraps computronium.core.presets.create_eqprop_mlp, adding backend selection.
"""
...
from computronium.core.presets import create_eqprop_mlp as _create_eqprop_mlp
...
def create_eqprop_mlp(
    ...
    *,
    ...
    """
    spec = get("algorithm.eqprop")
    backend = select_backend(spec, backend)

    return _create_eqprop_mlp(
        input_dim=input_dim,
