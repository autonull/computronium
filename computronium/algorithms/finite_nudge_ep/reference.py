"""Reference implementation for FiniteNudgeEp algorithm.

Composes Finite Nudge Ep training step using primitives.
"""
...
def _make_finite_nudge_ep_system(config: _SystemConfig) -> Any:
    """Create a FiniteNudgeEp system for testing."""
...
def step(case: Any) -> Any:
    ...
    try:
        ...
        system = _make_finite_nudge_ep_system(system_config)
