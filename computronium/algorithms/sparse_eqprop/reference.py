"""Reference implementation for SparseEqprop algorithm.

Composes Sparse Eqprop training step using primitives.
"""
...
def _make_sparse_eqprop_system(config: _SystemConfig) -> Any:
    """Create a SparseEqprop system for testing."""
...
def step(case: Any) -> Any:
    ...
    try:
        ...
        system = _make_sparse_eqprop_system(system_config)
