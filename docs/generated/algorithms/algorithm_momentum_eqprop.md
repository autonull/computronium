# Momentum Eqprop (algorithm.momentum_eqprop)
...
**Entrypoint:** `computronium.algorithms.momentum_eqprop.reference.step`

## Kernel Implementation

**Entrypoint:** `computronium.algorithms.momentum_eqprop.kernel.step`
