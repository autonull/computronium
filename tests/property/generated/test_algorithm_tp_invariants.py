"""Property tests for invariants of algorithm.tp."""
...
SPEC_ID = "algorithm.tp"


@pytest.fixture(scope="module")
def spec():
    return get("algorithm.tp")
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.tp.cases import make_case

    case1 = make_case(seed=seed)
    case2 = make_case(seed=seed)

    ref_module = import_module("computronium.algorithms.tp.reference")
