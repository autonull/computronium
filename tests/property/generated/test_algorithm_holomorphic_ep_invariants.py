"""Property tests for invariants of algorithm.holomorphic_ep."""
...
SPEC_ID = "algorithm.holomorphic_ep"


@pytest.fixture(scope="module")
def spec():
    return get("algorithm.holomorphic_ep")
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.holomorphic_ep.cases import make_case

    case1 = make_case(seed=seed)
    case2 = make_case(seed=seed)

    ref_module = import_module("computronium.algorithms.holomorphic_ep.reference")
