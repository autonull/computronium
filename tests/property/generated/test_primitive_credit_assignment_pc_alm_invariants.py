"""Property tests for invariants of primitive.credit_assignment.pc_alm."""
...
SPEC_ID = 'primitive.credit_assignment.pc_alm'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.credit_assignment.pc_alm')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.credit_assignment.pc_alm.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.credit_assignment.pc_alm.reference')
