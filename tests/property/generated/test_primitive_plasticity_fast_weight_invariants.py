"""Property tests for invariants of primitive.plasticity.fast_weight."""
...
SPEC_ID = 'primitive.plasticity.fast_weight'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.plasticity.fast_weight')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.plasticity.fast_weight.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.plasticity.fast_weight.reference')
