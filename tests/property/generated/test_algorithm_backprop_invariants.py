"""Property tests for invariants of algorithm.backprop."""
...
SPEC_ID = "algorithm.backprop"


@pytest.fixture(scope="module")
def spec():
    return get("algorithm.backprop")
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.backprop.cases import make_case

    case1 = make_case(seed=seed)
    case2 = make_case(seed=seed)

    ref_module = import_module("computronium.algorithms.backprop.reference")
