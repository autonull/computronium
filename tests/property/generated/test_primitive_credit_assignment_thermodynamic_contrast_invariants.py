"""Property tests for invariants of primitive.credit_assignment.thermodynamic_contrast."""
...
SPEC_ID = 'primitive.credit_assignment.thermodynamic_contrast'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.credit_assignment.thermodynamic_contrast')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.credit_assignment.thermodynamic_contrast.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.credit_assignment.thermodynamic_contrast.reference')
