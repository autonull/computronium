"""Property tests for invariants of primitive.state_dynamics.predictive_settling."""
...
SPEC_ID = 'primitive.state_dynamics.predictive_settling'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.state_dynamics.predictive_settling')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.state_dynamics.predictive_settling.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.state_dynamics.predictive_settling.reference')
