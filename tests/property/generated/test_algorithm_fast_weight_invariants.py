"""Property tests for invariants of algorithm.fast_weight."""
...
SPEC_ID = "algorithm.fast_weight"


@pytest.fixture(scope="module")
def spec():
    return get("algorithm.fast_weight")
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.fast_weight.cases import make_case

    case1 = make_case(seed=seed)
    case2 = make_case(seed=seed)

    ref_module = import_module("computronium.algorithms.fast_weight.reference")
