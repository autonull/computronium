"""Property tests for invariants of algorithm.hebbian."""
...
SPEC_ID = "algorithm.hebbian"


@pytest.fixture(scope="module")
def spec():
    return get("algorithm.hebbian")
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.hebbian.cases import make_case

    case1 = make_case(seed=seed)
    case2 = make_case(seed=seed)

    ref_module = import_module("computronium.algorithms.hebbian.reference")
