"""Property tests for invariants of algorithm.routing."""
...
SPEC_ID = "algorithm.routing"


@pytest.fixture(scope="module")
def spec():
    return get("algorithm.routing")
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.routing.cases import make_case

    case1 = make_case(seed=seed)
    case2 = make_case(seed=seed)

    ref_module = import_module("computronium.algorithms.routing.reference")
