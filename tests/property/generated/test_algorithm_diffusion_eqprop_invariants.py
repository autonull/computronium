"""Property tests for invariants of algorithm.diffusion_eqprop."""
...
SPEC_ID = "algorithm.diffusion_eqprop"


@pytest.fixture(scope="module")
def spec():
    return get("algorithm.diffusion_eqprop")
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.diffusion_eqprop.cases import make_case

    case1 = make_case(seed=seed)
    case2 = make_case(seed=seed)

    ref_module = import_module("computronium.algorithms.diffusion_eqprop.reference")
