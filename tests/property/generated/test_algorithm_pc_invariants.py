"""Property tests for invariants of algorithm.pc."""
...
SPEC_ID = 'algorithm.pc'


@pytest.fixture(scope="module")
def spec():
    return get('algorithm.pc')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.pc.cases import make_case
    ...
    ref_module = import_module('computronium.algorithms.pc.reference')
