"""Property tests for invariants of primitive.plasticity.rule_state."""
...
SPEC_ID = 'primitive.plasticity.rule_state'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.plasticity.rule_state')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.plasticity.rule_state.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.plasticity.rule_state.reference')
