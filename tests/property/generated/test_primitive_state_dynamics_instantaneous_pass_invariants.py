"""Property tests for invariants of primitive.state_dynamics.instantaneous_pass."""
...
SPEC_ID = 'primitive.state_dynamics.instantaneous_pass'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.state_dynamics.instantaneous_pass')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.state_dynamics.instantaneous_pass.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.state_dynamics.instantaneous_pass.reference')
