"""Property tests for invariants of primitive.parameter_update.elastic_consolidation."""
...
SPEC_ID = 'primitive.parameter_update.elastic_consolidation'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.parameter_update.elastic_consolidation')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.parameter_update.elastic_consolidation.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.parameter_update.elastic_consolidation.reference')
