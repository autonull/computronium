"""Property tests for invariants of primitive.plasticity.routing."""
...
SPEC_ID = 'primitive.plasticity.routing'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.plasticity.routing')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.plasticity.routing.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.plasticity.routing.reference')
