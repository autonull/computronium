"""Property tests for invariants of primitive.credit_assignment.target_inversion."""
...
SPEC_ID = 'primitive.credit_assignment.target_inversion'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.credit_assignment.target_inversion')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.credit_assignment.target_inversion.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.credit_assignment.target_inversion.reference')
