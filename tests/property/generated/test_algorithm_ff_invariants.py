"""Property tests for invariants of algorithm.ff."""
...
SPEC_ID = 'algorithm.ff'


@pytest.fixture(scope="module")
def spec():
    return get('algorithm.ff')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.ff.cases import make_case
    ...
    ref_module = import_module('computronium.algorithms.ff.reference')
