"""Property tests for invariants of primitive.credit_assignment.local_goodness."""
...
SPEC_ID = 'primitive.credit_assignment.local_goodness'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.credit_assignment.local_goodness')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.credit_assignment.local_goodness.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.credit_assignment.local_goodness.reference')
