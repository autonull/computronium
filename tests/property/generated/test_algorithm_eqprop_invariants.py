"""Property tests for invariants of algorithm.eqprop."""
...
SPEC_ID = 'algorithm.eqprop'


@pytest.fixture(scope="module")
def spec():
    return get('algorithm.eqprop')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.eqprop.cases import make_case
    ...
    ref_module = import_module('computronium.algorithms.eqprop.reference')
