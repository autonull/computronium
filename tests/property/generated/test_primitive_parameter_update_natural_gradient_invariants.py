"""Property tests for invariants of primitive.parameter_update.natural_gradient."""
...
SPEC_ID = 'primitive.parameter_update.natural_gradient'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.parameter_update.natural_gradient')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.parameter_update.natural_gradient.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.parameter_update.natural_gradient.reference')
