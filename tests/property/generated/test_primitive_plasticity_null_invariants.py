"""Property tests for invariants of primitive.plasticity.null."""
...
SPEC_ID = 'primitive.plasticity.null'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.plasticity.null')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.plasticity.null.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.plasticity.null.reference')
