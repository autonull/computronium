"""Property tests for invariants of primitive.credit_assignment.homeostatic."""
...
SPEC_ID = 'primitive.credit_assignment.homeostatic'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.credit_assignment.homeostatic')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.credit_assignment.homeostatic.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.credit_assignment.homeostatic.reference')
