"""Property tests for invariants of algorithm.finite_nudge_ep."""
...
SPEC_ID = 'algorithm.finite_nudge_ep'


@pytest.fixture(scope="module")
def spec():
    return get('algorithm.finite_nudge_ep')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.finite_nudge_ep.cases import make_case
    ...
    ref_module = import_module('computronium.algorithms.finite_nudge_ep.reference')
