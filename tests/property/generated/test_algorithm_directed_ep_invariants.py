"""Property tests for invariants of algorithm.directed_ep."""
...
SPEC_ID = 'algorithm.directed_ep'


@pytest.fixture(scope="module")
def spec():
    return get('algorithm.directed_ep')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.directed_ep.cases import make_case
    ...
    ref_module = import_module('computronium.algorithms.directed_ep.reference')
