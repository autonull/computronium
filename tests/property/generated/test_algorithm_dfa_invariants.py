"""Property tests for invariants of algorithm.dfa."""
...
SPEC_ID = 'algorithm.dfa'


@pytest.fixture(scope="module")
def spec():
    return get('algorithm.dfa')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.dfa.cases import make_case
    ...
    ref_module = import_module('computronium.algorithms.dfa.reference')
