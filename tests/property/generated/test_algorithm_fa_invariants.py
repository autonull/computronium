"""Property tests for invariants of algorithm.fa."""
...
SPEC_ID = "algorithm.fa"


@pytest.fixture(scope="module")
def spec():
    return get("algorithm.fa")
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.fa.cases import make_case

    case1 = make_case(seed=seed)
    case2 = make_case(seed=seed)

    ref_module = import_module("computronium.algorithms.fa.reference")
