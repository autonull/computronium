"""Property tests for invariants of primitive.plasticity.temporal_psi."""
...
SPEC_ID = 'primitive.plasticity.temporal_psi'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.plasticity.temporal_psi')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.plasticity.temporal_psi.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.plasticity.temporal_psi.reference')
