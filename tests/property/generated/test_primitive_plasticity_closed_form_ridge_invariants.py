"""Property tests for invariants of primitive.plasticity.closed_form_ridge."""
...
SPEC_ID = 'primitive.plasticity.closed_form_ridge'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.plasticity.closed_form_ridge')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.plasticity.closed_form_ridge.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.plasticity.closed_form_ridge.reference')
