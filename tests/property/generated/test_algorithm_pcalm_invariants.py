"""Property tests for invariants of algorithm.pcalm."""
...
SPEC_ID = "algorithm.pcalm"


@pytest.fixture(scope="module")
def spec():
    return get("algorithm.pcalm")
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.pcalm.cases import make_case

    case1 = make_case(seed=seed)
    case2 = make_case(seed=seed)

    ref_module = import_module("computronium.algorithms.pcalm.reference")
