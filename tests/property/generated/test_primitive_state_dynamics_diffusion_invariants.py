"""Property tests for invariants of primitive.state_dynamics.diffusion."""
...
SPEC_ID = 'primitive.state_dynamics.diffusion'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.state_dynamics.diffusion')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.state_dynamics.diffusion.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.state_dynamics.diffusion.reference')
