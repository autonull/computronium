"""Property tests for invariants of primitive.credit_assignment.temporal_trace."""
...
SPEC_ID = 'primitive.credit_assignment.temporal_trace'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.credit_assignment.temporal_trace')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.credit_assignment.temporal_trace.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.credit_assignment.temporal_trace.reference')
