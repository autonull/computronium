"""Property tests for invariants of primitive.parameter_update.muon."""
...
SPEC_ID = 'primitive.parameter_update.muon'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.parameter_update.muon')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.parameter_update.muon.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.parameter_update.muon.reference')
