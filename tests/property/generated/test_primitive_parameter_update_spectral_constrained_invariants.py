"""Property tests for invariants of primitive.parameter_update.spectral_constrained."""
...
SPEC_ID = 'primitive.parameter_update.spectral_constrained'


@pytest.fixture(scope="module")
def spec():
    return get('primitive.parameter_update.spectral_constrained')
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.primitives.parameter_update.spectral_constrained.cases import make_case
    ...
    ref_module = import_module('computronium.primitives.parameter_update.spectral_constrained.reference')
