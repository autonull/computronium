"""Property tests for invariants of algorithm.tile."""
...
SPEC_ID = "algorithm.tile"


@pytest.fixture(scope="module")
def spec():
    return get("algorithm.tile")
...
def test_deterministic_under_fixed_seed(spec, seed):
    ...
    from computronium.algorithms.tile.cases import make_case

    case1 = make_case(seed=seed)
    case2 = make_case(seed=seed)

    ref_module = import_module("computronium.algorithms.tile.reference")
