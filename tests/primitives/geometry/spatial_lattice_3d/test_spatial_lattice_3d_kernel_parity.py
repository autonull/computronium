"""Kernel parity tests for Spatial Lattice 3D Geometry primitive."""
...
def test_kernel_parity():
    ...
    spec = get("primitive.geometry.spatial_lattice_3d")

    if "kernel" not in spec.supported_backends:
        pytest.skip("no kernel backend")

    # Import kernel module to check availability
    from computronium.primitives.geometry.spatial_lattice_3d import kernel
