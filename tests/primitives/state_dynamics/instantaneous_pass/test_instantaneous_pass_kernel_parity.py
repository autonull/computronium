"""Kernel parity tests for Instantaneous Pass primitive."""

import pytest

from computronium.acceleration.parity import assert_parity
from computronium.primitives.state_dynamics.instantaneous_pass import (
    SPEC,
    make_case,
    reference_step,
)
from computronium.primitives.state_dynamics.instantaneous_pass.kernel import (
    is_available,
)
from computronium.primitives.state_dynamics.instantaneous_pass.kernel import (
    step as kernel_step,
