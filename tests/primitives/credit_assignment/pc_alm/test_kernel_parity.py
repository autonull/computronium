"""Tests for PC-ALM Credit Assignment kernel parity."""

import pytest

from computronium.acceleration.parity import assert_parity
from computronium.acceleration.registry import get
from computronium.primitives.credit_assignment.pc_alm import (
    make_case,
    reference_step,
)
...
try:
    from computronium.primitives.credit_assignment.pc_alm.kernel import (
        is_available,
    )
    from computronium.primitives.credit_assignment.pc_alm.kernel import (
        step as kernel_step,
...
spec = get("primitive.credit_assignment.pc_alm")
