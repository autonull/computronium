"""Tests for Temporal Trace Credit case factory."""

import torch

from computronium.primitives.credit_assignment.temporal_trace import make_case
...
def test_make_case_deterministic():
    ...
    assert _config_equal(case1.config, case2.config, {"seed", "loss", "target"})
