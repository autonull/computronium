"""Tests for Homeostatic kernel parity."""

import pytest

from computronium.acceleration.parity import assert_parity
from computronium.acceleration.registry import get
from computronium.primitives.credit_assignment.homeostatic import (
    make_case,
    reference_step,
)
...
try:
    from computronium.primitives.credit_assignment.homeostatic.kernel import (
        is_available,
    )
    from computronium.primitives.credit_assignment.homeostatic.kernel import (
        step as kernel_step,
