"""Case factory tests for Target Inversion primitive."""

import torch

from computronium.primitives.credit_assignment.target_inversion.cases import (
    Case,
    make_case,
)
