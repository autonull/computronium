"""Test cases for Complex Substrate primitive."""
...
from computronium.primitives.substrate.complex import make_case
...
def test_make_case_returns_case():
    ...
    assert case.spec.numeric_representation == NumericRepresentation.COMPLEX
...
def test_make_case_config_structure():
    ...
    assert case.config["precision"] == "complex"
