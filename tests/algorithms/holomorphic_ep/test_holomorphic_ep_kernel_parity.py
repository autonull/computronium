"""Kernel parity tests for HolomorphicEp algorithm."""
...
from computronium.algorithms.holomorphic_ep import (
    kernel_step,
    make_case,
    reference_step,
)
...
def test_kernel_parity():
    ...
    from computronium.algorithms.holomorphic_ep import kernel
