"""Tests for Direct Feedback Alignment algorithm kernel parity."""
...
try:
    from computronium.algorithms.dfa.kernel import is_available
    from computronium.algorithms.dfa.kernel import step as kernel_step
