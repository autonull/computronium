"""Kernel parity tests for Backprop algorithm."""
...
from computronium.algorithms.backprop import (
    kernel_step,
    make_case,
    reference_step,
)
