"""Kernel parity tests for MomentumEqprop algorithm."""
...
from computronium.algorithms.momentum_eqprop import (
    kernel_step,
    make_case,
    reference_step,
)
...
def test_kernel_parity():
    ...
    from computronium.algorithms.momentum_eqprop import kernel
