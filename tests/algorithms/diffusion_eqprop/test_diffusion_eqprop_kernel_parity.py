"""Kernel parity tests for DiffusionEqprop algorithm."""
...
from computronium.algorithms.diffusion_eqprop import (
    kernel_step,
    make_case,
    reference_step,
)
...
def test_kernel_parity():
    ...
    from computronium.algorithms.diffusion_eqprop import kernel
