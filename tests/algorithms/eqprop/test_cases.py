"""Test cases for EqProp algorithm."""

import torch

from computronium.algorithms.eqprop import make_case
from computronium.ontology.geometry import RecurrentGeometry
...
def test_make_case_returns_case():
    ...
    assert isinstance(case.geometry, RecurrentGeometry)
