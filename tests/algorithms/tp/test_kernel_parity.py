"""Tests for Target Propagation algorithm kernel parity."""

import pytest

from computronium.acceleration.parity import assert_parity
from computronium.acceleration.registry import get
from computronium.algorithms.tp import (
    make_case,
    reference_step,
)
...
try:
    from computronium.algorithms.tp.kernel import is_available
    from computronium.algorithms.tp.kernel import step as kernel_step
