"""Kernel parity tests for TernaryEqprop algorithm."""
...
from computronium.algorithms.ternary_eqprop import (
    kernel_step,
    make_case,
    reference_step,
)
...
def test_kernel_parity():
    ...
    from computronium.algorithms.ternary_eqprop import kernel
