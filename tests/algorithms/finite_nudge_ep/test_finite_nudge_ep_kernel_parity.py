"""Kernel parity tests for FiniteNudgeEp algorithm."""
...
from computronium.algorithms.finite_nudge_ep import (
    kernel_step,
    make_case,
    reference_step,
)
...
def test_kernel_parity():
    ...
    from computronium.algorithms.finite_nudge_ep import kernel
