"""Test cases for Tile algorithm."""

import torch

from computronium.algorithms.tile import make_case
from computronium.ontology.geometry import TileGeometry
...
def test_make_case_returns_case():
    ...
    assert isinstance(case.geometry, TileGeometry)
