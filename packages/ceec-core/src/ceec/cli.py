...
Usage:
    uv run python -m ceec.cli <command> [options]
"""
...
def _export(args: argparse.Namespace) -> int:
    from ceec import audit, calibration
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="ceec.cli")
